...
<body class="bg-gradient-primary">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" method="post" action="<?=base_url()?>Register/register">
    ...
    <script>
        registered="<?php echo $this->session->registered ?>"
        if (registered=="no") {
            alert('Not succesfully registered');
        }
                
        formvali="<?php echo validation_errors(); ?>"
        if (formvali) {
            alert(formvali);
        }
    </script>
